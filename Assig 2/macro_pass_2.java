...
public class macro_pass_2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BufferedWriter bw=new BufferedWriter(new FileWriter("pass2Output/pass2_output.txt"));
			BufferedReader br2=new BufferedReader(new FileReader("pass1Output/ALA.txt")); 
